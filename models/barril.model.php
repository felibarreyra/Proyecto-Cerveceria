...
public function obtenerNombreLugar($id_lugar) {
    ...
    function vaciarBarril($codigo) {
        ...
        $sql = "UPDATE barriles SET estado='VACIO' ,id_lugar=4 ,id_variedad=4 , fecha_venta=NULL WHERE codigo=?";
    ...
    public function obtenerBarrilesEnCamaraActuales() {
        $sql = "SELECT id_variedad, litros, COUNT(*) as cantidad 
                FROM barriles 
                WHERE id_lugar = 1 
                GROUP BY id_variedad, litros";
